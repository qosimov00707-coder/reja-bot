...
export default function Weekly() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white flex items-center gap-2">📅 O'tgan Hafta</h1>
      ...
      <div className="bg-[oklch(0.13_0.014_285)] rounded-xl p-5 border border-[oklch(0.22_0.014_285)]">
        ...
        <table className="w-full text-sm">
          <thead><tr className="text-[oklch(0.55_0.01_280)]">
            ...
            {taskStats.map(t => (
              <tr key={t.taskId}>
                ...
                <td className="py-3 text-right">
                  <span className={`px-2 py-0.5 rounded text-xs font-semibold ${t.percent >= 70 ? 'bg-[oklch(0.72_0.18_160)] text-black' : 'bg-[oklch(0.22_0.014_285)] text-[oklch(0.55_0.01_280)]'}`}>{t.percent}%</span>
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="bg-[oklch(0.13_0.014_285)] rounded-xl p-5 border border-[oklch(0.22_0.014_285)]">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div><p className="text-[oklch(0.55_0.01_280)] text-sm mb-1">Kunlar Soni</p><p className="text-2xl font-bold text-white">7</p></div>
        </div>
      </div>
    </div>
  );
